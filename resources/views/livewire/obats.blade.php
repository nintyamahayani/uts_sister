<div>
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 mt-5">
            ...
            <table class="table-fixed w-full">
                <thead class="bg-blue-500">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-white">Obat</th>
                ...
                <tbody class="text-center">
                    ...
                    <tr>
                        ...
                        <td>{{$obat->harga}}</td>
                        <td>
                            <button wire:click="edit({{$obat->id}} )" class="py-1 px-4 text-sm rounded text-blue-500 font-semibold border border-blue-500 hover:text-white font-bold hover:bg-blue-500 hover:border-transparent focus:outline-none">Edit</button></a>
                            <button wire:click="delete({{$obat->id}} )" class="py-1 px-4 text-sm rounded text-red-500 font-semibold border border-red-500 hover:text-white font-bold hover:bg-red-500 hover:border-transparent focus:outline-none">Delete</button></a>
                        </td>
                    </tr>
                    <?php $id++; ?>
                    @endforeach
        ...
        <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
            <div class="text-center text-sm text-black sm:text-left">
